...
listOfFiles = ['file:/eos/cms/store/relval/CMSSW_12_4_0/RelValSingleMuPt100/MINIAODSIM/124X_mcRun3_2022_realistic_v5-v1/2580000/4f8561ca-7140-41d7-b5cb-53034ed1fd70.root']
...
process.load("MuonReco-Analysis.MuonReco-analyzer.displacedMuonsPATAnalysis_cfi")
process.displacedMuonsPATAnalysis.nameOfOutput = 'output_displacedMuonsPATAnalysis.root'
process.displacedMuonsPATAnalysis.muonCollection = 'slimmedDisplacedMuons'

## Running sequence
#process.displacedMuons = cms.Sequence(process.displacedMuonsPATAnalysis)


process.p = cms.EndPath(process.displacedMuonsPATAnalysis)
